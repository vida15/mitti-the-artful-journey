  ...
  return (
    ...
    <div className="grid grid-cols-1 gap-12 px-6 py-16 md:grid-cols-[3fr_2fr] md:gap-16 md:px-10 md:py-24">
      ...
      <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-wrap gap-2">
              {sizes.map((s) => (
                <button
                  ...
                  style={{
                    borderColor: size === s.label ? "var(--color-ember)" : "rgba(65,100,74,0.4)",
        ...
        {/* Provenance */}
        <div className="grid grid-cols-2 gap-x-6 gap-y-4 border-y py-6" style={{ borderColor: "rgba(89,80,130,0.2)" }}>
          {[
        ...
        {p.artists && (
          <Link to="/artists/$slug" params={{ slug: p.artists.slug }} data-cursor="view" className="group flex items-center gap-4 border-t pt-6" style={{ borderColor: "rgba(89,80,130,0.2)" }}>
...
function RelatedWorks({ productId, artistId }: { productId: string; artistId: string | null }) {
  ...
  return (
    <section className="border-t px-6 py-20 md:px-10 md:py-24" style={{ borderColor: "rgba(89,80,130,0.2)" }}>
