    ...
    <div className="px-6 py-16 md:px-10 md:py-24">
      <div className="grid grid-cols-1 gap-12 md:grid-cols-[2fr_3fr] md:gap-16">
        ...
        <div>
          ...
          <div className="mt-10 grid grid-cols-3 gap-4 border-t pt-6" style={{ borderColor: "rgba(89,80,130,0.2)" }}>
            <div>
      ...
      {a.bio && (
        <div className="mx-auto my-24 max-w-3xl border-y py-12 text-center" style={{ borderColor: "rgba(89,80,130,0.2)" }}>
