...
function ArtistsPage() {
  ...
  return (
    <div className="px-6 py-16 md:px-10 md:py-24">
      ...
      {/* Filter bar */}
      <div className="mt-24 mb-10 flex flex-wrap items-center gap-3 border-y py-5" style={{ borderColor: "rgba(89,80,130,0.18)" }}>
        ...
        {regions.map((r) => (
          <button
            ...
            style={{
              borderColor: region === r ? "var(--color-ember)" : "rgba(89,80,130,0.3)",
              color: region === r ? "var(--color-ember)" : "var(--color-bone)",
              backgroundColor: region === r ? "rgba(248,198,98,0.08)" : "transparent",
            }}
          >
            {r}
          </button>
      ...
      {/* Manifesto closing */}
      <div className="mt-32 border-t pt-16 text-center" style={{ borderColor: "rgba(89,80,130,0.18)" }}>
