...
export function Footer() {
  return (
    <footer className="relative overflow-hidden border-t" style={{ backgroundColor: "var(--color-ash)", borderColor: "rgba(59,88,103,0.4)" }}>
      <div
        aria-hidden
      ...
      <div className="relative mx-auto flex max-w-7xl items-center justify-between border-t px-6 py-6 font-mono text-[10px] uppercase md:px-10" style={{ borderColor: "rgba(59,88,103,0.4)", color: "var(--color-dust)" }}>
