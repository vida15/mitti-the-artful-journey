...
const accents = ["var(--color-ember)", "var(--color-ochre)", "var(--color-electric)", "var(--color-violet)"];

export function Process() {
  return (
    <section className="px-6 py-24 md:px-10 md:py-32" style={{ backgroundColor: "var(--color-ink)" }}>
        ...
        <div className="mt-20 grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          {steps.map((s, i) => (
            ...
            >
              ...
              <h3 className="mt-3 font-display text-4xl tracking-wide" style={{ color: "var(--color-bone)" }}>{s.title}</h3>
