...
function Success() {
  ...
  return (
    <div className="flex min-h-[80vh] flex-col items-center justify-center px-6 text-center">
      <p className="font-mono text-[11px] uppercase tracking-widest" style={{ color: "var(--color-bone)" }}>Order placed</p>
      ...
      <Link to="/" data-cursor="link" className="mt-12 font-mono text-xs uppercase underline-offset-8 hover:underline" style={{ color: "var(--color-bone)" }}>
        ← Back home
      </Link>
    </div>
  );
